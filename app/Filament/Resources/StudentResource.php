...
class StudentResource extends Resource
{
    ...
    protected static ?string $permission = 'student-list';
        ...
        return $form
            ...
            ->schema([
                ...
                ->required(),
                    ...
                    //->options(fn (Get $get): Collection => Quarter::query()
                    //->where('township_id', $get('township_id'))
                    //->pluck('name','id'))
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                //    Filter::make('township-section-filter')
                //    ->form([
                //     select::make('township_id')
                //     ->label('Filter By Township')
                //     ->placeholder(('Select a state'))
                //     ->options(
                //         Township::pluck('name','id')->toArray(),

                //     )
                //    ])
                //    ->query(function (Builder $query, array $data ): Builder{

                //         return $query->when($data['township_id'],function($query) use ($data)
                //         {
                //         $query->where('township_id');
                //         });
                //    }),
            ])
            ->actions([
